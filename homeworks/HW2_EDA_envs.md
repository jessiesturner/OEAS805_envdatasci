# OEAS805 Homework 2: EDA and environments - due 9/28/2026

Create a new folder in your OEAS805 repository called `HW2` where you will save the code and files you create for this homework assignment. You will also create a new conda environment called `hw2_env` including all of the packages you need to complete your assignment.
...
## Part 1 (18 points): Exploratory Data Analysis (EDA)
...
## Part 2 (2 points): Sharing your environment
...
## Homework submission:
To submit your homework, upload the link to Canvas for your github repository containing your HW2 folder which should have your EDA juputer notebook and `hw2_env.yml` files saved in it. 

Your homework will incur a 10% per day late penalty if submitted after the deadline. I will not accept any work submitted after midnight on October 5<sup>th</sup>.
